---
name: memoz-brainstorming
description: "Work out what is wanted before building it: search the knowledge layer for prior decisions, find the intent under the request, widen the options, name the constraint that decides it, and stop at a decision record. Use before implementing a feature or picking an approach."
---

<!-- GENERATED from core/brainstorming.md — do not edit. Run: node scripts/render.mjs -->
