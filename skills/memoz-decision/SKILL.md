---
name: memoz-decision
description: "Record a decision together with the options rejected and the ground each was rejected on, plus what observation would reopen it. Use when a choice is made that outlives the task."
---
