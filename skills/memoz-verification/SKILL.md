---
name: memoz-verification
description: "Produce the evidence before claiming a piece of work is done, fixed or working: state the claim, run the thing that would disprove it, confirm the tooling actually ran, and report what remains unverified. Use before finishing work, committing, or reporting a result."
---

<!-- GENERATED from core/verification.md — do not edit. Run: node scripts/render.mjs -->
